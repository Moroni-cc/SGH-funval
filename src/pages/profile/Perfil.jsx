...
export default function Profile() {
  ...
  const handleProfileSubmit = async (e) => {
    ...
    if (!formData.email.endsWith("@funval.com")) {
      setProfileToast({
        type: "error",
        text: "El correo debe pertenecer al dominio @funval.com",
      });
      return;
    }
    ...
    try {
      ...
      setProfileToast({
        type: "error",
        text: "Error al actualizar el perfil. Verifica los datos.",
      });
    } finally {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto p-4 md:p-8 space-y-6 bg-[#f8fafc] min-h-screen">
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
        ...
        {profileToast && (
          <div
            className={`mb-4 p-3 rounded-md text-sm font-medium ${profileToast.type === "error" ? "bg-red-50 text-red-700" : "bg-green-50 text-green-700"}`}
          >
            {profileToast.text}
          </div>
        )}
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
        ...
        {passwordToast && (
          <div
            className={`mb-4 p-3 rounded-md text-sm font-medium ${passwordToast.type === "error" ? "bg-red-50 text-red-700" : "bg-green-50 text-green-700"}`}
          >
            {passwordToast.text}
          </div>
        )}
        ...
        <form onSubmit={handlePasswordSubmit} className="space-y-6">
          ...
          <div>
            <button
              ...
              className="px-6 py-2 border border-gray-300 text-gray-700 rounded-md text-sm font-medium hover:bg-gray-50 transition-colors disabled:opacity-50"
            >
